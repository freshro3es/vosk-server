    ...
    def transcribe_file(self):
        async def transcribe():
            ...
            async with websockets.connect(uri) as websocket:
                ...
                buffer_size = int(
                    target_samples * (original_rate // 512)
                ...
                while True:
                    if not active_sentence:
                        ...
                        start_time_in_seconds = wf.tell() / wf.getframerate()
                    ...
                    if '"result"' in result:
                        result = process_result(
                            result, start_time_in_seconds, wf.tell() / wf.getframerate()
                        )
                        active_sentence = False
                ...
                final_result = process_result(
                    final_result, start_time_in_seconds, wf.tell() / wf.getframerate()
                )
