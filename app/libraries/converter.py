...
def mp3_to_wav(file, buffer: int) -> str:
    try:
        ...
        output_file = sf.SoundFile(new_filepath, 'w', samplerate=input_file.samplerate, channels=input_file.channels)
        ...
        while input_file.tell() < input_file.frames:
            ...
            logging.info(f'pos is {pos} and framerate is {input_file.samplerate}, type is {input_file.format}, size is {input_file.frames}, raw data type is {data.dtype}')
